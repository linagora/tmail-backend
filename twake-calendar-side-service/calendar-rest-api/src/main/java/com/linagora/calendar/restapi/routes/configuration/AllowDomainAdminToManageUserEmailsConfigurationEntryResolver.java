...
public class AllowDomainAdminToManageUserEmailsConfigurationEntryResolver implements ConfigurationEntryResolver {
    @Override
    ...
    public ConfigurationKey configurationKey() {
        return new ConfigurationKey("allowDomainAdminToManageUserEmails");
    }
}
