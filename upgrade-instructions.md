...
You can also find more detailed instructions for releases under the respective server apps:
- distributed: `tmail-backend/apps/distributed/src/doc/release-instructions/`
- postgres: `tmail-backend/apps/postgres/src/doc/release-instructions/`
