...
```
docker run -e "JAVA_TOOL_OPTIONS=-Xmx500m -Xms500m" linagora/openpaas-james-memory
```
...
```
docker run -e "JAVA_TOOL_OPTIONS=-javaagent:/root/glowroot/glowroot.jar" linagora/openpaas-james-memory
```
