...
public class MailboxIndexCreationUtil {
    ...
    public static ReactorElasticSearchClient prepareClient(ReactorElasticSearchClient client,
                                                           ...
                                                           IndexName indexName,
                                                           OpenDistroConfiguration configuration) {
    ...
    public static ReactorElasticSearchClient prepareDefaultClient(ReactorElasticSearchClient client, OpenDistroConfiguration configuration) {
