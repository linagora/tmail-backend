...
import static org.apache.james.mailbox.opendistro.OpenDistroConfiguration.SSLConfiguration.SSLValidationStrategy.OVERRIDE;
...
public class OpenDistroConfiguration {
    ...
    public static final OpenDistroConfiguration DEFAULT_CONFIGURATION = builder()
        .addHost(Host.from(LOCALHOST, DEFAULT_PORT))
        .build();

    public static OpenDistroConfiguration fromProperties(Configuration configuration) throws ConfigurationException {
        return builder()
    ...
    private OpenDistroConfiguration(ImmutableList<Host> hosts, int nbShards, int nbReplica, int waitForActiveShards, int minDelay, int maxRetries, Duration requestTimeout,
    ...
    @Override
    public final boolean equals(Object o) {
        if (o instanceof OpenDistroConfiguration) {
            OpenDistroConfiguration that = (OpenDistroConfiguration) o;
