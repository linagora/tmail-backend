...
class OpenDistroClusterExtension implements AfterAllCallback, BeforeAllCallback, AfterEachCallback, ParameterResolver {

    static class ElasticSearchCluster {
        DockerOpenDistro es1;
        DockerOpenDistro es2;

        ElasticSearchCluster(DockerOpenDistro es1, DockerOpenDistro es2) {
            this.es1 = es1;
            this.es2 = es2;
        }
    ...
    OpenDistroClusterExtension(ElasticSearchCluster esCluster) {
