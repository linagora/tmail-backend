...
Before running the TMail distributed server, you need to generate a RSA key pair. This is something up to you to generate
the keys with necessary certificates related to your production environment domain.

When you have your RSA key pair ready, then you can finally start the TMail distributed server:
