...
=== SenderIsPayingUser matcher

The `SenderIsPayingUser` matcher can be used to determine if the sender of an email is a paying SaaS user based on their subscription plan. This matcher can be used to apply specific processing rules for paying users.