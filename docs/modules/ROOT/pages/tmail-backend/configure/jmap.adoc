...
| Optional. Configures the support contact mail address. Example: `sypport@my-domain.com`. Cannot be configured at the same time than `support.httpLink`.

| `support.httpLink`
| Optional. Configures the support contact HTTP link. Example: `https://my-domain.com/support`. Cannot be configured at the same time than `support.mail.address`.
