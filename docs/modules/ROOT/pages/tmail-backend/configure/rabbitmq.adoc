...
- `twp.saas.user.created.exchange`: Optional. The exchange name for SaaS B2B user creation configuration. Default to `auth`.
- `twp.saas.user.created.routingKey`: Optional. The routing key for SaaS B2B user creation configuration. Default to `user.created`.
