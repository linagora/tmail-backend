...
from the blob id of the calendar file (.ics).
 ...
 - link:ecosystemDiscovery.adoc[Linagora ecosystem discovery] allows clients to discover Linagora ecosystem service URLs, application metadata, and feature flags.
