...
The `publicAssetTotalSize` object is an `UnsignedInt` representing the quota of public assets allowed for the user, in Mb.
...
- *size*: `UnsignedInt`. Server-set. The size of the PublicAsset.
- *contentType*: `String`. Server-set. The content type of the PublicAsset.
