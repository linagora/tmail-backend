...
Twake mail define some sender controls, defined by the business category of the LDAP group:
 ...
 - *internalListonly james users can send mail to the list
 - *memberRestrictedListonly members of the list can send mail to the list
 - *ownerRestrictedListonly owners of the list can send mail to the list
 - *domainRestrictedListonly members of the domain can send mail to the list
