...
package com.linagora.tmail.saas.api.mailet;
...
import com.linagora.tmail.saas.mailet.SenderIsPayingUser;
import com.linagora.tmail.saas.model.SaaSAccount;
import com.linagora.tmail.saas.model.SaaSPlan;

import reactor.core.publisher.Mono;

public class SenderIsPayingUserTest {
    @Test
    void shouldReturnRecipientWhenSenderIsPremiumUser() throws Exception {
        ...
        SenderIsPayingUser isSenderPayingUser = new SenderIsPayingUser(saaSAccountRepository);

        MailAddress recipient = new MailAddress("james-user@james.org");
        Collection<MailAddress> matched = isSenderPayingUser.match(FakeMail.builder()
            .name("default-id")
    ...
    @Test
    void shouldNotReturnRecipientWhenSenderIsFreeUser() throws Exception {
        SaaSAccountRepository saaSAccountRepository = new MemorySaaSAccountRepository();
