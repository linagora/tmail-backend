...
class NaiveTMailWithMailingListsValidRcptHandlerTest {
    ...
    private NaiveTMailWithMailingListsValidRcptHandler testee;
    ...
    void setUp() throws Exception {
        ...
        domainList.addDomain(Domain.of("lists.linagora.com"));
        ...
        testee = new NaiveTMailWithMailingListsValidRcptHandler(usersRepository, rrt, domainList, teamMailboxRepository);
    }
