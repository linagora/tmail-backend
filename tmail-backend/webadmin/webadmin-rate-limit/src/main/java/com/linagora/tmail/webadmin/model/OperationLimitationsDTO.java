...
public class OperationLimitationsDTO {
    ...
    public OperationLimitationsDTO(List<RateLimitationDTO> rateLimitationDTOList) {
        assureNotEmpty(rateLimitationDTOList);
    ...
    private void assureNotEmpty(List<RateLimitationDTO> list) {
        if (list.isEmpty()) {
            throw new IllegalArgumentException("Operation limitation arrays must have at least a entry.");
        }
    }
}
