...
import com.linagora.tmail.james.common.LinagoraContactAutocompleteMethodContract.{bobAccountId, contactA, contactB, firstnameA, firstnameB, mailAddressA, mailAddressB, surnameA, surnameB}
...
trait LinagoraContactAutocompleteMethodContract {
  ...
  def contactAutocompleteShouldFailWhenWrongAccountId(): Unit = {
    val request =
      s"""{
         |  "using": ["urn:ietf:params:jmap:core", "com:linagora:params:jmap:contact"],
         |  "methodCalls": [[
  ...
  def contactAutocompleteShouldFailWhenMissingCapability(): Unit = {
    ...
    assertThatJson(response).isEqualTo(
      s"""{
         ...
         |  "methodResponses": [
         |    ["error", {
         |      "description":"Missing capability(ies): com:linagora:params:jmap:contact","type":"unknownMethod"
         |    }, "c1"]
         |  ]
         |}""".stripMargin)
  }
