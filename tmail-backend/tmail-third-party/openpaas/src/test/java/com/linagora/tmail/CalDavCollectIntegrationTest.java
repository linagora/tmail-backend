...
public class CalDavCollectIntegrationTest {
    ...
    void mailetShouldCallDavSeverToCreateNewCalendarObject(@TempDir File temporaryFolder) throws Exception {
        String uri = "/calendars/" + ALICE_ID + "/" + ALICE_ID + "/ea127690-0440-404b-af98-9823c855a283.ics";
        davServerExtension.addMockOfCreatingCalendarObject(uri);
        ...
        davServerExtension.assertMockOfCreatingCalendarObjectWasCalled(uri, 1);
    }
}
