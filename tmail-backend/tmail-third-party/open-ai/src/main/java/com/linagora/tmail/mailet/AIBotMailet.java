 ...
 * <li><b>baseURL</b>: The base URL of the LLM's API.</li>
 * <li><b>model</b>: This is LLM model to be used, formatted as <em>{llm_api},{llm_model}</em>. Both values are optional, and if not provided, the default will be <b>openai,gpt-3.5-turbo</b> as configured by Langchain4j. For testing purposes, you can use the model <b>openai,gpt-4o-mini</b> with the demo API key.</li>
 * </ul>
 */
