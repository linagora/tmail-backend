...
public class RagConfig {
    public static final String AUTHORIZATION_TOKEN_PARAMETER_NAME = "openrag.token";
    public static final String TRUST_ALL_CERTIFICATES_PARAMETER_NAME = "openrag.ssl.trust.all.certs";
    public static final String BASE_URL_PARAMETER_NAME = "openrag.url";
    public static final String PARTITION_PATTERN_PARAMETER_NAME = "openrag.partition.pattern";
