...
public class TMailReportsRoute implements Routes {
    ...
    public static final String BASE_PATH = "/plugin/reports";

    private final MailReportGenerator receivedMailReportGenerator;
    private final Clock clock;

    @Inject
    public TMailReportsRoute(MailReportGenerator receivedMailReportGenerator, Clock clock) {
