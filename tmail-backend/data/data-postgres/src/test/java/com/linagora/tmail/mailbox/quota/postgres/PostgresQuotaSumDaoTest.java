...
public class PostgresQuotaSumDaoTest implements QuotaSumDaoContract {
    ...
    private PostgresQuotaSumDao postgresQuotaSumDao;
    private PostgresCurrentQuotaManager currentQuotaManager;

    @BeforeEach
    void setUp() {
        PostgresQuotaCurrentValueDAO currentValueDAO = new PostgresQuotaCurrentValueDAO(postgresExtension.getDefaultPostgresExecutor());
        postgresQuotaSumDao = new PostgresQuotaSumDao(postgresExtension.getDefaultPostgresExecutor());
        currentQuotaManager = new PostgresCurrentQuotaManager(currentValueDAO);
    }
