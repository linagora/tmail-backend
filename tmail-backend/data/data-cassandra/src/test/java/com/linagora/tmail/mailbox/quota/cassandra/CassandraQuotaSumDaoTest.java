...
public class CassandraQuotaSumDaoTest implements QuotaSumDaoContract {
    ...
    private CassandraQuotaSumDao cassandraQuotaSumDao;
    private CassandraCurrentQuotaManagerV2 currentQuotaManager;

    @BeforeEach
    void setUp() {
        cassandraQuotaSumDao = new CassandraQuotaSumDao(cassandraCluster.getCassandraCluster().getConf());
        currentQuotaManager = new CassandraCurrentQuotaManagerV2(new CassandraQuotaCurrentValueDao(cassandraCluster.getCassandraCluster().getConf()));
    }
