...
public class DeletedMessageVaultWorkQueueProbe implements GuiceProbe {
    private final DistributedDeletedMessageVaultDeletionCallback distributedDeletedMessageVaultDeletionCallback;

    @Inject
    public DeletedMessageVaultWorkQueueProbe(DistributedDeletedMessageVaultDeletionCallback distributedDeletedMessageVaultDeletionCallback) {
        this.distributedDeletedMessageVaultDeletionCallback = distributedDeletedMessageVaultDeletionCallback;
    }

    public void stop() {
        distributedDeletedMessageVaultDeletionCallback.stop();
    }
}
