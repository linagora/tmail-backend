...
public class OpenPaasContactsConsumerProbe implements GuiceProbe {
    private final OpenPaasContactsConsumer openPaasContactsConsumer;

    @Inject
    public OpenPaasContactsConsumerProbe(OpenPaasContactsConsumer openPaasContactsConsumer) {
        this.openPaasContactsConsumer = openPaasContactsConsumer;
    }

    public void stop() {
        openPaasContactsConsumer.close();
    }
}
