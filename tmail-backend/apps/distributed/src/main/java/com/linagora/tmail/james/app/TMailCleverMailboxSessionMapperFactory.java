 ...
 */
public class TMailCleverMailboxSessionMapperFactory extends MailboxSessionMapperFactory implements AttachmentMapperFactory  {
    ...
    private final TMailCleverCassandraAttachmentMapper cassandraAttachmentMapper;
    ...
    @Inject
    public TMailCleverMailboxSessionMapperFactory(UidProvider uidProvider, ModSeqProvider modSeqProvider, CqlSession session,
        ...
        this.cassandraAttachmentMapper = new TMailCleverCassandraAttachmentMapper(attachmentDAOV2, blobStore, new StringBackedAttachmentIdFactory());
