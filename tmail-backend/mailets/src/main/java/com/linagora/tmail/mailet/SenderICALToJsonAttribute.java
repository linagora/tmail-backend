...
package com.linagora.tmail.james.jmap.mailet;
 ...
 *
 * Used to make OpenPaaS work with the CalendarEvent/reply extention.
 *
 ...
 *     <li><b>recipient</b> : the recipient of the mail.  This is hard coded as the sender of the mail</li>
...
public class SenderICALToJsonAttribute extends GenericMailet {
    ...
    public SenderICALToJsonAttribute() {
