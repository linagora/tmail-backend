...
class CalendarEventAcceptMethod @Inject()(val attendanceStatusPerformer: CalendarEventAttendanceStatusPerformer,
  ...
  override def doProcess(capabilities: Set[CapabilityIdentifier],
    ...
    attendanceStatusPerformer.process(mailboxSession, request, AttendanceStatus.Accepted)
